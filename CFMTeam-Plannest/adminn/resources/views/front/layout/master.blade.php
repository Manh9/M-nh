                                            ...
                                            <tbody>
                                                @foreach (Cart::content() as $cart)
                                                    <tr data-rowId="{{ $cart->rowId }}">
                                                        <td class="si-pic"><img style="height: 60px;"
                                                                src="img/products/{{ $cart->options->images[0]->path }}"
                                                                alt=""></td>
                                                        <td class="si-text">
                ...
                <div class="nav-depart">
                    <div class="depart-btn">
                        ...
                        <ul class="depart-hover">
                            ...
                            <li class="active"><a href="#">Flowering</a></li>

                            <li><a href="./shop">Non-Flowering</a></li>

                            <li><a href="./shop">Succulents</a></li>
