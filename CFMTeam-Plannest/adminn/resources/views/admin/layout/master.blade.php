                            ...
                            <div class="widget-content-left">
                                <div class="btn-group">
                                    <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                       class="p-0 btn">
                                        <img width="42" class="rounded-circle" src="front/img/user/{{ Auth::user()->avatar ?? 'avatar-default.jpg' }}"
                                             alt="">
                                                        ...
                                                        <div class="widget-content-wrapper">
                                                            <div class="widget-content-left mr-3">
                                                                <img width="42" class="rounded-circle"
                                                                     src="front/img/user/{{ Auth::user()->avatar ?? 'avatar-default.jpg' }}" alt="">
                                                            </div>
                                                            <div class="widget-content-left">
                                                            ...
                                                            <div class="widget-content-right mr-2">
                                                                <a href="/" class="btn-pill btn-shadow btn-shine btn btn-focus">Logout</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="./admin/brand" class="{{ (request()->segment(2) == 'brand') ? 'mm-active' : ''}}">
                                        <i class="metismenu-icon"></i>Environment
                                    </a>
                                </li>
                            </ul>
                        </li>
