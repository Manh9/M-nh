$(function () {
    ...
    $('#showForm').on('click', function() {   // When click o add item button
    ...
    // CLICK HANDLING USES DELEGAYION ON <ul> ELEMENT
    $list.on('click', 'li', function() {
        var $this = $(this);                         // Cache the element in a jQuery abject
        ...
        if (complete === true) {                     // Check if item is complete
            ...
            $list                                    // Add back to end of list as complete
                ...
                .hide().fadeIn(300);                 // Hide it so can be foded in
