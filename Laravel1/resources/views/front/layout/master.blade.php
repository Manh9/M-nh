...
<head>
    ...
    <title>@yield('title') | Websale</title>
        ...
        <div class="container">
            <div class="ht-left">
                <div class="mail-service">
                    ...
                    nguyenbamanh@gmail.com
                </div>
                <div class="phone-service">
                    <a href="tel:+84 36.57.41.416"><i class="fa fa-phone"></i>+84 36.57.41.416</a>
                </div>
            </div>
            <div class="ht-right">
                @if(Auth::check())
                ...
                <div class="col-lg-12">
                    <div class="copyright-text">
                        ...
                        All rights reserved | This template is made with <i class="fa fa-heart-o"
                            ...
                            href="DucOnline.vn" target="_blank">DucOnline</a>
                    </div>
